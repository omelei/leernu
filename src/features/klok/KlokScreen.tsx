...
/**
 * The same counter the other two round bars use, and the same reason it is kept
 * off a phone in a round that has dots: the bar at 393 cannot hold a stop, ten
